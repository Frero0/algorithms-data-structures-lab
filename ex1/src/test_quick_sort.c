...
void test_null_array(void)
{
  ...
  quick_sort(actual, 0, 0, compare_int);
  TEST_ASSERT_NULL(actual);
}
...
{
  int actual[] = {42};
  quick_sort(actual, 0, sizeof(actual[0]), compare_int);
  TEST_ASSERT_EQUAL_INT(42, actual[0]);
}
...
void test_int_array(void)
{
  ...
  quick_sort(actual, 11, sizeof(actual[0]), compare_int);
...
void test_long_array(void)
{
  ...
  quick_sort(actual, 9, sizeof(actual[0]), compare_long);
...
void test_float_array(void)
{
  ...
  quick_sort(actual, 9, sizeof(actual[0]), compare_float);
...
void test_char_array(void)
{
  ...
  quick_sort(actual, 9, sizeof(actual[0]), compare_char);
...
void test_string_array(void)
{
  ...
  quick_sort(actual, 9, sizeof(actual[0]), compare_string);
...
void test_array_with_only_duplicated_elements(void)
{
  ...
  quick_sort(actual, 10, sizeof(actual[0]), compare_int);
...
void test_negative_int_array(void)
{
  ...
  quick_sort(actual, 9, sizeof(actual[0]), compare_int);
...
void test_records_array(void)
{
  ...
  quick_sort(actual, 9, sizeof(actual[0]), compare_records_string);
  for (unsigned long i = 0; i < sizeof(actual) / sizeof(actual[0]); i++)
  {
    TEST_ASSERT_EQUAL_STRING(expected[i].field1, actual[i].field1);
  }
  quick_sort(actual, 9, sizeof(actual[0]), compare_records_int);
  for (unsigned long i = 0; i < sizeof(actual) / sizeof(actual[0]); i++)
  {
    TEST_ASSERT_EQUAL_INT(expected[i].field2, actual[i].field2);
  }
  quick_sort(actual, 9, sizeof(actual[0]), compare_records_float);
  for (unsigned long i = 0; i < sizeof(actual) / sizeof(actual[0]); i++)
  {
